...
" TODO
" file with no slash, no glob, match any file with name regardless of path
" endfunction
...
" FUNCTION: function! ignore#sources#gitignore#filename(line) abort
"
...
" FUNCTION: function! ignore#sources#gitignore#filepath(line) abort
" AND
